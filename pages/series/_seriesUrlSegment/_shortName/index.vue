        ...
        <div>
          <div>
            <div class="next-box" v-if="nextVideo.id">
              ...
              <nuxt-link :to="{
                name: (
                  nextVideo.seriesUrlSegment ?
                  'series-seriesUrlSegment-shortName' :
                  'artists-artistUrlSegment-shortName'
                ),
                params: nextVideo
              }">
            ...
            <div class="next-box" v-if="youMightLikeVideos.length">
              ...
              <nuxt-link :to="{
                name: (
                  youMightLikeVideos[0].seriesUrlSegment ?
                  'series-seriesUrlSegment-shortName' :
                  'artists-artistUrlSegment-shortName'
                ),
                params: youMightLikeVideos[0]
              }">
    ...
    <div id="video-sidebar" class="container">
      <div class="currently-playing">
        ...
        <div class="btn-group">
          ...
          <a href="#" @click.prevent="showAddTo = !showAddTo" v-show="artist.iHeartRadioUrl">
      ...
      <div class="add-to-container" v-show="showAddTo">
        <a :href="artist.iHeartRadioUrl" v-show="artist.iHeartRadioUrl" target="_blank">
          <img src="~/assets/img/iheartradio-logo.svg"/>
        </a>
      </div>
      ...
      <ScrollBox class="you-might-like" v-if="youMightLikeVideos.length">
        <nuxt-link :to="{ name: 'artists-artistUrlSegment-shortName', params: video }" class="card" v-for="video in youMightLikeVideos" :key="video.id">
          ...
          <div class="card-details">
            <h1 class="card-subtitle">{{ getFirst(video, 'artists').artistNames }}</h1>
...
export default {
  ...
  computed: {
    ...
    artistKey() {
      return this.pageParams.seriesUrlSegment
    },
